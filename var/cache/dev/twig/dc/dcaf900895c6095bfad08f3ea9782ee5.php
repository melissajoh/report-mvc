...
class __TwigTemplate_22db3abce39f06d8b94679c977842f17 extends Template
{
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1>Shuffled card deck</h1>
    <div class=\"carddeck\">
        ";
        // line 8
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["shuffled"]) || array_key_exists("shuffled", $context) ? $context["shuffled"] : (function () { throw new RuntimeError('Variable "shuffled" does not exist.', 8, $this->source); })()));
...
{% block title %}Shuffled card deck{% endblock %}

{% block body %}
    <h1>Shuffled card deck</h1>
    <div class=\"carddeck\">
        {% for card in shuffled %}
            <span class=\"cards {{ card }}\">{{ card }}</span>
        {% endfor %}
    </div>
{% endblock %}
", "card/shuffle.html.twig", "/home/meljoh/dbwebb-kurser/mvc/me/report/templates/card/shuffle.html.twig");
    }
}
